...
class ManagePatient extends Component {
    ...
    getDataPatient = async () => {
        ...
        console.log("checkkkk resss", res)
        ...
        console.log("check dataaa", this.state.dataPatient)
    }
    ...
    render() {
        ...
        // console.log("check stateeeeeea: ", this.state)
        return (
            <>
                <LoadingOverlay
                        ...
                        <div className='manage-patient-body row'>
                            ...
                            <div className='col-12 table-manage-patient'>
                                <table style={{width: '100%'}}>
                                    <tbody>
                                        <tr style={{background: '#3737d9', color: "white"}}>
                                            <th>STT</th>
                                            <th>Thời gian</th>
                                            <th>Họ và tên</th>
                                            <th>Địa chỉ</th>
