...
import { getAllCodeService, createNewUserService, getAllUsers, 
        deleteUserSevice, editUserSevice, getTopDoctorHomeService, getAllDoctors, 
...
export const fetchTopDoctor = () =>{
    return async(dispatch, getState) => {
        try{
            ...
            console.log('FETCH_TOP_DPCTORS_FAILED', e)
            dispatch({
                type: actionTypes.FETCH_TOP_DOCTORS_FAILED
            })
        }
...
export const fetchAllDoctors = () =>{
    return async(dispatch, getState) => {
        try{
            ...
            console.log('FETCH_ALL_DPCTORS_FAILED', e)
            dispatch({
                type: actionTypes.FETCH_ALL_DOCTORS_FAILED
            })
        }
